...
class CardAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        ('Terrarium', {'fields': ['detention_difficulty', 'minimal_vivarium_size', 'temperature_day', 'temperature_night', 'temperature_high', 'temperature_low', 'humidity']}),
        ('Image', {'fields': ['image']}),
...
class AmphibienAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        ('Terrarium', {'fields': ['detention_difficulty', 'minimal_vivarium_size', 'temperature_day', 'temperature_night', 'temperature_high', 'temperature_low', 'humidity', 'life_community']}),
    ...
    exclude = ('slug',)
    list_display = ('genus', 'species', 'approved')
    search_fields = ['genus', 'species', 'environments__name', 'temperature_day', 'temperature_night', 'temperature_high', 'temperature_low', 'humidity', 'minimal_vivarium_size']
    list_filter = ('genus',)
