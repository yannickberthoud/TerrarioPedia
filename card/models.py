...
class Card(models.Model):
    ...
    temperature_high = models.PositiveIntegerField(verbose_name="Température point chaud")
    temperature_low = models.PositiveIntegerField(verbose_name="Température point froid")
