...
class Card(models.Model):
    ...
    dentitions = models.CharField(max_length=1, verbose_name="Dentition", default='A', choices=DENTITIONS)
    ...
    venom_toxicity_risks = models.CharField(max_length=1, verbose_name="niveau de toxicité", help_text="Dangerosité d'une envenimation", choices=VENOM_TOXICITIES_RISK, blank=True)
